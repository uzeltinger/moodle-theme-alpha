...
/**
 * Class theme_alpha_core_h5p_renderer.
 *
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_alpha_core_h5p_renderer extends \core_h5p\output\renderer {
    /**
    ...
    protected function get_style_url($content) {
        ...
        return \moodle_url::make_file_url(
            ...
            "/$syscontext->id/theme_alpha/hvp/$itemid/themehvp.css"
        );
    }
}
